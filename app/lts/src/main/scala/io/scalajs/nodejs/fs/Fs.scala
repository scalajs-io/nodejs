...
trait Fs extends IEventEmitter with FSConstants {
  ...
  /**
    ...
    */
  def copyFile(src: Buffer | String, dest: Buffer | String, flags: Flags, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @example {{{ fs.copyFile(src, dest[, flags], callback) }}}
    */
  def copyFile(src: Buffer | String, dest: Buffer | String, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  def copyFileSync(src: Buffer | String, dest: Buffer | String, flags: Flags): Unit = js.native
  ...
  def exists(path: Buffer | String, callback: js.Function1[Boolean, Any]): Unit = js.native
  ...
  /**
    ...
    */
  def existsSync(path: Buffer | String): Boolean = js.native
  ...
  /**
    ...
    */
  def rename(oldPath: Buffer | String, newPath: Buffer | String, callback: FsCallback0): Unit = js.native
  ...
  /**
    ...
    */
  def renameSync(oldPath: Buffer | String, newPath: Buffer | String): Unit = js.native
