...
trait BodyParser extends js.Object {
  ...
  /**
    ...
    */
  def json(options: JsonBodyOptions = js.native): Router = js.native
  ...
  /**
    ...
    */
  def raw(options: RawBodyOptions = js.native): Router = js.native
  ...
  /**
    ...
    */
  def text(options: TextBodyOptions = js.native): Router = js.native
  ...
  /**
    ...
    */
  def urlencoded(options: UrlEncodedBodyOptions = js.native): Router = js.native
