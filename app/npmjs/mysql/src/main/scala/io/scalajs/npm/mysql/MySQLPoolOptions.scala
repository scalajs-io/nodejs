...
/**
  ...
  *                           requests. (Default: 0)
  */
class MySQLPoolOptions(var acquireTimeout: js.UndefOr[Int] = js.undefined,
...
/**
  * Pool Options Companion
  * @author lawrence.daniels@gmail.com
  */
object MySQLPoolOptions extends FlexibleOptions[MySQLPoolOptions]