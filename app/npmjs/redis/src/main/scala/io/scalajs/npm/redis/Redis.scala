...
class RedisClientOptions(val host: js.UndefOr[String] = js.undefined,
                         ...
                         val parser: js.UndefOr[String] = js.undefined,
                         val string_numbers: js.UndefOr[Boolean] = js.undefined,
                         val return_buffers: js.UndefOr[Boolean] = js.undefined,
                         val detect_buffers: js.UndefOr[Boolean] = js.undefined,
                         val socket_keepalive: js.UndefOr[Boolean] = js.undefined,
                         val no_ready_check: js.UndefOr[Boolean] = js.undefined,
                         val enable_offline_queue: js.UndefOr[Boolean] = js.undefined,
                         val retry_max_delay: js.UndefOr[Int] = js.undefined,
                         val connect_timeout: js.UndefOr[Int] = js.undefined,
                         val max_attempts: js.UndefOr[Int] = js.undefined,
                         val retry_unfulfilled_commands: js.UndefOr[Boolean] = js.undefined,
                         val password: js.UndefOr[String] = js.undefined,
                         val db: js.UndefOr[String] = js.undefined,
                         val family: js.UndefOr[String] = js.undefined,
                         val disable_resubscribing: js.UndefOr[String] = js.undefined,
                         val rename_commands: js.UndefOr[js.Dictionary[String]] = js.undefined,
                         val tls: js.UndefOr[RedisTLS] = js.undefined,
                         val prefix: js.UndefOr[String] = js.undefined,
                         val retry_strategy: js.UndefOr[js.Function] = js.undefined)
  extends js.Object