...
trait TypeIs extends js.Object {
  ...
  /**
    ...
    * @param request the given [[RequestType request]]
    * @return a Boolean if the given request has a body, regardless of the Content-Type header.
    */
  def hasBody(request: RequestType): Boolean = js.native
  ...
  /**
    ...
    */
  def is(request: RequestType, types: js.Array[String]): js.Any = js.native
