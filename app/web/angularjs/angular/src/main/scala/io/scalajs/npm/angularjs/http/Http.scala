...
trait Http extends js.Object {
  ...
  /**
    ...
    */
  def apply[T <: js.Any](config: HttpConfig): js.Promise[HttpResponse[T]] = js.native
  ...
  def get[T <: js.Any](url: String,
                       ...
                       headers: js.Dictionary[js.Any] = js.native): js.Promise[HttpResponse[T]] = js.native
  ...
  /**
    ...
    * @return a [[HttpResponse promise]] of an response
    */
  def head[T <: js.Any](url: String, config: HttpConfig = js.native): js.Promise[HttpResponse[T]] = js.native
  ...
  /**
    ...
    * @return a [[HttpResponse promise]] of an response
    */
  def jsonp[T <: js.Any](url: String, config: HttpConfig = js.native): js.Promise[HttpResponse[T]] = js.native
  ...
  def post[T <: js.Any](url: String,
                        ...
                        responseType: String = js.native): js.Promise[HttpResponse[T]] = js.native
