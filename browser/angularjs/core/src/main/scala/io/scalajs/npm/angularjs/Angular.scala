...
import io.scalajs.dom.{Document, Element}
...
object Angular {
  ...
  final implicit class RichAngular(val self: Angular) extends AnyVal {
    ...
    @inline
    def bootstrap(element: Element, modules: Iterable[String]): Injector = {
      self.bootstrap(element, modules.toJSArray.asInstanceOf[js.Array[Any]])
    }

    @inline
    def bootstrap(element: Element, modules: Seq[DependencySet]): Injector = {
    ...
    @inline
    def bootstrap(element: Element, modules: Iterable[String], config: AngularConfiguration): Injector = {
      self.bootstrap(element, modules.toJSArray.asInstanceOf[js.Array[Any]], config)
    }

    @inline
    def bootstrap(element: Element, modules: Seq[DependencySet], config: AngularConfiguration): Injector = {
