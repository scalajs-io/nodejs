package org.scalajs.dom.canvas

import java.lang.{Double => JDouble}

import org.scalajs.dom.browser.{Blob, File}
...
trait HTMLCanvasElement extends js.Object {
  ...
  /**
    ...
    */
  def toDataURL(`type`: String = null, encoderOptions: CanvasEncoderOptions = null): String = js.native
...
object HTMLCanvasElement {
  ...
  final implicit class HTMLCanvasElementExtensions(val canvas: HTMLCanvasElement) extends AnyVal {
    ...
    @inline
    def get2DContext(contextAttributes: CanvasAttributeOptions = null) = {
      canvas.getContext("2d", contextAttributes).asInstanceOf[CanvasRenderingContext2D]
    }

    @inline
    def getBitmapContext(contextAttributes: CanvasAttributeOptions = null) = {
      canvas.getContext("bitmaprenderer", contextAttributes).asInstanceOf[ImageBitmapRenderingContext]
    }

    @inline
    def getWebGLContext(contextAttributes: CanvasAttributeOptions = null) = {
      canvas.getContext("webgl", contextAttributes).asInstanceOf[WebGLRenderingContext]
    }

    @inline
    def getWebGL2Context(contextAttributes: CanvasAttributeOptions = null) = {
      canvas.getContext("webgl2", contextAttributes).asInstanceOf[WebGL2RenderingContext]
    }

    @inline
    def toBlobFuture(mimeType: String = null, qualityArgument: JDouble = null) = {
