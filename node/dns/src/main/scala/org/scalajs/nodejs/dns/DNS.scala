...
object DNS {
  ...
  /**
    ...
    */
  implicit class HttpExtensions(val dns: DNS) extends AnyVal {
    ...
    /**
      ...
      * On error, err is an Error object, where err.code is the error code.
      */
    def lookupServiceFuture(address: String, port: Int) = {
    ...
    /**
      ...
      * @param hostname the hostname
      */
    def resolveFuture[T](hostname: String, rrtype: RRType = null) = {
    ...
    /**
      ...
      */
    def reverseFuture(ipAddress: String) = futureCallbackE1[DnsError, js.Array[String]](dns.reverse(ipAddress, _))
