...
object ClientRequest {
  ...
  implicit class ClientRequestEnrich(val request: ClientRequest) extends AnyVal {
    ...
    @inline
    def endFuture(data: js.Any, encoding: String) = futureCallbackE1[js.Error, js.Any](request.end(data, encoding, _))

    @inline
    def writeFuture(chunk: js.Any, encoding: String) = futureCallbackE1[js.Error, js.Any](request.write(chunk, encoding, _))
