...
trait Collection extends js.Object {
  ...
  /**
    ...
    */
  def aggregate(pipeline: js.Any, options: AggregationOptions, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @example aggregate(pipeline, options, callback)
    */
  def aggregate(pipeline: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  def bulkWrite(operations: js.Array[js.Any], options: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  def count(query: js.Any, options: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  def createIndex(fieldOrSpec: js.Any, options: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @example createIndex(fieldOrSpec, options[, callback])
    */
  def createIndex[T](fieldOrSpec: js.Any, options: js.Any): Promise[T] = js.native
  ...
  /**
    ...
    */
  def deleteMany(filter: js.Any, options: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  @deprecated("Use dropIndexes", since = "2.x")
  ...
  /**
    ...
    */
  @deprecated("Use findOneAndUpdate, findOneAndReplace or findOneAndDelete instead", since = "2.x")
  def findAndModify(query: js.Any, sort: js.Array[js.Any], doc: js.Any, options: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  @deprecated("Use findOneAndUpdate, findOneAndReplace or findOneAndDelete instead", since = "2.x")
  def findAndModify[T <: js.Any](query: js.Any, sort: js.Array[js.Any], doc: js.Any, options: js.Any = null): Promise[T] = js.native
  ...
  /**
    ...
    */
  @deprecated("Use find().limit(1).next(function(err, doc){})", since = "2.x")
  ...
  /**
    ...
    */
  @deprecated("Use find().limit(1).next(function(err, doc){})", since = "2.x")
  def findOne[T <: js.Any](query: js.Any, options: js.Any = null): Promise[T] = js.native
  ...
  /**
    ...
    */
  def findOneAndUpdate(filter: js.Any, update: js.Any, options: FindAndUpdateOptions, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @example findOneAndUpdate(filter, update, options, callback)
    */
  def findOneAndUpdate(filter: js.Any, update: js.Any, options: FindAndUpdateOptions = null): Promise[FindAndModifyWriteOpResult] = js.native
  ...
  /**
    ...
    */
  def group(keys: js.Any, condition: js.Any, initial: js.Any, reduce: js.Any, finalize: js.Any, command: js.Any, options: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @return Promise if no callback passed
    */
  def indexExists(indexes: js.Array[String], callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @return Promise if no callback passed
    */
  def indexExists(indexes: String, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  def insert[T <: js.Any](doc: T): Unit = js.native
  ...
  /**
    ...
    */
  def insert[T <: js.Any](doc: T, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @param callback The command result callback
    */
  def insert[T <: js.Any](doc: T, options: WriteOptions, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @param callback The command result callback
    */
  @deprecated("Use insertOne, insertMany or bulkWrite", since = "2.x")
  ...
  /**
    ...
    */
  def insertMany[T <: js.Any](docs: js.Array[T], options: WriteOptions, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @param callback The command result callback
    */
  def insertOne(doc: js.Any, options: WriteOptions, callback: js.Function): Unit = js.native

  /**
    * Returns if the collection is a capped collection
    * @example isCapped(callback): Promise
    */
  def isCapped(): Promise[BulkWriteResult] = js.native
  ...
  /**
    ...
    * @example isCapped(callback): Promise
    */
  def isCapped(callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @return the options of the collection.
    */
  def options[T <: js.Any](): Promise[T] = js.native
  ...
  /**
    ...
    * (indexes are rebuilt in the foreground) and will be slow for large collections.
    */
  def reIndex[T <: js.Any](): Promise[T] = js.native

  /**
    * Remove documents.
    */
  @deprecated("Use deleteOne, deleteMany or bulkWrite", since = "2.x")
  ...
  /**
    ...
    * @return [[Promise]] if no callback passed
    */
  def rename[T <: js.Any](newName: String, options: js.Any): Promise[T] = js.native
  ...
  /**
    ...
    * @param options Optional settings.
    */
  def replaceOne[T <: js.Any](filter: js.Any, doc: js.Any, options: js.Any): Promise[T] = js.native
  ...
  /**
    ...
    * @param callback The command result callback
    */
  @deprecated("Use insertOne, insertMany, updateOne or updateMany", since = "2.x")
  ...
  /**
    ...
    * @param options Optional settings.
    */
  def stats[T <: js.Any](options: js.Any = null): Promise[T] = js.native
  ...
  /**
    ...
    * @param callback The command result callback
    */
  @deprecated("Use updateOne, updateMany or bulkWrite", since = "2.x")
  def update(selector: js.Any, document: js.Any, options: WriteOptions, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  @deprecated("Use updateOne, updateMany or bulkWrite", since = "2.x")
  def update(selector: js.Any, document: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    */
  @deprecated("Use updateOne, updateMany or bulkWrite", since = "2.x")
  def update[T <: js.Any](selector: js.Any, document: js.Any, options: WriteOptions = null): Promise[T] = js.native
  ...
  /**
    ...
    * @param callback The command result callback
    */
  def updateMany(filter: js.Any, update: js.Any, options: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @param callback The command result callback
    */
  def updateMany(filter: js.Any, update: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @param options Optional settings.
    */
  def updateMany[T <: js.Any](filter: js.Any, update: js.Any, options: js.Any = null): Promise[T] = js.native
  ...
  /**
    ...
    * @return [[Promise]] if no callback passed
    */
  def updateOne(filter: js.Any, update: js.Any, options: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @return [[Promise]] if no callback passed
    */
  def updateOne(filter: js.Any, update: js.Any, callback: js.Function): Unit = js.native
  ...
  /**
    ...
    * @return [[Promise]] if no callback passed
    */
  def updateOne[T <: js.Any](filter: js.Any, update: js.Any, options: js.Any = null): Promise[T] = js.native
...
object Collection {
  ...
  /**
    ...
    */
  type MongoResultCallBack = js.Function2[MongoError, BulkWriteResult, Unit]
  ...
  implicit class MongoCollectionExtensions(val coll: Collection) extends AnyVal {
    ...
    @inline
    def dropAsync = callback2ToFuture[MongoError, OperationResult](coll.drop)

    @inline
    def findAsync[T <: js.Any] = callback2ToFuture[MongoError, js.Array[T]](coll.find().toArray)

    @inline
    def findAsync[T <: js.Any](selector: js.Any) = callback2ToFuture[MongoError, js.Array[T]](coll.find(selector).toArray)

    @inline
    def findAsync[T <: js.Any](selector: js.Any, projection: js.Any) = {
      callback2ToFuture[MongoError, js.Array[T]](coll.find(selector, projection).toArray)
    }

    @inline
    def findOneAsync[T <: js.Any](selector: js.Any)(implicit ec: ExecutionContext) = {
      callback2ToFuture[MongoError, T](coll.find(selector).limit(1).nextObject) map (Option(_))
    }
    ...
    @inline
    def updateAsync(selector: js.Any, modifier: js.Any) = {
      callback2ToFuture[MongoError, WriteResult](coll.update(selector, modifier, WriteOptions(w = 1), _))
    }
