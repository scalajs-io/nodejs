...
trait Fs extends IEventEmitter {
  ...
  /**
    ...
    */
  def createReadStream(path: String | Buffer, options: FileInputOptions | NodeOptions = null): Readable = js.native
  ...
  /**
    ...
    */
  def realpathSync(path: String, options: FileEncodingOptions | NodeOptions = null): String = js.native
