...
trait QueryString extends js.Object {
  ...
  /**
    ...
    */
  def parse(str: String, sep: String = js.native, eq: String = js.native, options: QueryDecodeOptions | NodeOptions = js.native): js.Dictionary[String] = js.native
  ...
  /**
    ...
    */
  def stringify(obj: js.Any, sep: String = js.native, eq: String = js.native, options: QueryEncodeOptions | NodeOptions = js.native): String = js.native
