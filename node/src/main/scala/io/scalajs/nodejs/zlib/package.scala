...
package object zlib {
  ...
  final implicit class ZlibExtensions(val zlib: Zlib) extends AnyVal {
    ...
    /**
      ...
      */
    @inline
    def deflateFuture(buf: String | Buffer, options: CompressionOptions | NodeOptions = null): Promise[Buffer] = {
    ...
    /**
      ...
      */
    @inline
    def deflateRawFuture(buf: String | Buffer, options: CompressionOptions | NodeOptions = null): Promise[Buffer] = {
    ...
    /**
      ...
      */
    @inline
    def gzipFuture(buf: String | Buffer, options: CompressionOptions | NodeOptions = null): Promise[Buffer] = {
    ...
    /**
      ...
      */
    @inline
    def gunzipFuture(buf: String | Buffer, options: CompressionOptions | NodeOptions = null): Promise[Buffer] = {
    ...
    /**
      ...
      */
    @inline
    def inflateFuture(buf: String | Buffer, options: CompressionOptions | NodeOptions = null): Promise[Buffer] = {
    ...
    /**
      ...
      */
    def inflateRawFuture(buf: String | Buffer, options: CompressionOptions | NodeOptions = null): Promise[Buffer] = {
    ...
    /**
      ...
      */
    @inline
    def unzipFuture(buf: String | Buffer, options: CompressionOptions | NodeOptions = null): Promise[Buffer] = {
