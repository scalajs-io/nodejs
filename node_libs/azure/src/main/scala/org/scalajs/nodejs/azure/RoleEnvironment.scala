...
object RoleEnvironment {
  ...
  implicit class RoleEnvironmentExtensions(val roleEnvironment: RoleEnvironment) extends AnyVal {
    ...
    /**
      ...
      */
    @inline
    def getConfigurationSettingsFuture = futureCallbackE1[Error, js.Dictionary[String]](roleEnvironment.getConfigurationSettings(_))

    /**
      * Obtains information about endpoints defined for the current role instance.
      */
    @inline
    def getCurrentRoleInstanceFuture = futureCallbackE1[Error, Role](roleEnvironment.getCurrentRoleInstance(_))
    ...
    /**
      ...
      */
    @inline
    def getLocalResourcesFuture = futureCallbackE1[Error, js.Array[Resource]](roleEnvironment.getLocalResources(_))

    /**
      * Obtains information about endpoints in role instances running on other machines
      */
    @inline
    def getRolesFuture = futureCallbackE1[Error, js.Array[Role]](roleEnvironment.getRoles(_))
    ...
    /**
      ...
      */
    @inline
    def isAvailableFuture = futureCallbackE1[Error, Boolean](roleEnvironment.isAvailable(_))
