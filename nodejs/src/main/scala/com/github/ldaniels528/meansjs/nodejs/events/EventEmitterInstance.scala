...
/**
  ...
  */
@js.native
trait EventEmitterInstance extends js.Object {
  ...
  def EventEmitter: js.Function0[EventEmitterInstance] = js.native
  ...
  /**
    ...
    * @see [[EventEmitterInstance.setMaxListeners()]]
    */
