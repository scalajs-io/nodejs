...
trait Http extends js.Object {
  ...
  /**
    ...
    */
  def request(options: Http.RequestOptions, callback: js.Function1[ServerResponse, Unit]): Unit = js.native
  ...
  /**
    ...
    * @example http.request(options[, callback])
    */
  def request(options: Http.RequestOptions): Unit = js.native
