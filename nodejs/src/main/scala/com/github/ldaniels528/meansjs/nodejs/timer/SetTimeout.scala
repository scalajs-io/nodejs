...
trait SetTimeout extends js.Object {
  ...
  /**
    ...
    */
  def apply(callback: js.Function, delay: Int, args: js.Array[js.Any]): Timeout = js.native
  ...
  /**
    ...
    * @example setTimeout(callback, delay[, arg][, ...])
    */
  def apply(callback: js.Function, delay: Int): Timeout = js.native

}

/**
  * Set Timeout Companion
  * @author lawrence.daniels@gmail.com
  */
object SetTimeout {
