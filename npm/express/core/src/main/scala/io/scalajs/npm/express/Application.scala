...
/**
  ...
  */
@js.native
trait Application extends IEventEmitter with Router {
  ...
  /**
    ...
    */
  def listen(port: Int | String, hostname: String, backlog: Int, callback: js.Function): Server = js.native

  /**
    * Binds and listens for connections on the specified host and port.
    * This method is identical to Node’s http.Server.listen().
    */
  def listen(port: Int | String, hostname: String, backlog: Int): Server = js.native

  /**
    * Binds and listens for connections on the specified host and port.
    * This method is identical to Node’s http.Server.listen().
    */
  def listen(port: Int | String, hostname: String, callback: js.Function): Server = js.native

  /**
    * Binds and listens for connections on the specified host and port.
    * This method is identical to Node’s http.Server.listen().
    */
  def listen(port: Int | String, hostname: String): Server = js.native
  ...
  /**
    ...
    * This method is identical to Node’s http.Server.listen().
    */
  def listen(port: Int | String): Server = js.native
