...
trait Router extends js.Object {
  ...
  /**
    ...
    */
  def all(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def connect(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def delete(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def get(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def head(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def options(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def patch(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def post(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def put(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
  ...
  /**
    ...
    */
  def trace(path: String, callback: js.Function, callbacks: js.Function*): this.type = js.native
