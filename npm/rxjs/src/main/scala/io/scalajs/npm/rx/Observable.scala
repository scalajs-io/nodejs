...
trait Observable[T] extends js.Object {
  ...
  /**
    ...
    */
  def map[S](selector: js.Function | js.Any, thisArg: js.Any = js.native): Observable[S] = js.native
...
object Observable {
  ...
  implicit class ObservableExtensions[A](val observable: Observable[A]) extends AnyVal {
    ...
    /**
      ...
      */
    @inline
    def filterWith(predicate: A => Boolean): Observable[A] = observable.filter(predicate: js.Function)

    /**
      * @see [[Observable.filter()]]
      */
    @inline
    def filterWith(predicate: (A, Int) => Boolean): Observable[A] = observable.filter(predicate: js.Function)
    ...
    /**
      ...
      */
    @inline
    def flatMapWith[B](selector: A => B): Observable[B] = observable.flatMap(selector: js.Function)

    /**
      * @see [[Observable.flatMap()]]
      */
    @inline
    def flatMapWith[B](selector: (A, Int) => B): Observable[B] = observable.flatMap(selector: js.Function)
    ...
    /**
      ...
      */
    @inline
    def mapWith[B](selector: A => B): Observable[B] = observable.map[B](selector = selector: js.Function)

    /**
      * @see [[Observable.map()]]
      */
    @inline
    def mapWith[B](selector: (A, Int) => B): Observable[B] = observable.map[B](selector = selector: js.Function)

    /**
      * @see [[Observable.map()]]
      */
    @inline
    def mapWith[B](selector: (A, Int, Observable[A]) => B, thisArg: js.Any = null): Observable[B] = {
