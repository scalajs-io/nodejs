...
@js.native
@JSImport("tingodb", "Db")
class Db(val databaseName: String, val options: js.Any = js.native) extends js.Object {
...
/**
  * TingoDB Database Companion
  * @author lawrence.daniels@gmail.com
  */
object Db {

  /**
    * TingoDB Database Extensions
    * @author lawrence.daniels@gmail.com
    */
  implicit class TingoDatabaseExtensions(val db: Db) extends AnyVal {
