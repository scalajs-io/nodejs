...
/**
  ...
  */
@js.native
trait TransducersJs extends NodeModule {

  /**
    * Given a transformer return a concatenating transformer
    * @param xf a [[com.cognitect.transducers.ITransformer transformer]]
    * @return a concatenating [[com.cognitect.transducers.ITransformer transformer]]
...
/**
  * Transducers-Js Companion
  * @author lawrence.daniels@gmail.com
  */
object TransducersJs {

  /**
    * Convenience method for retrieving the transducer-js module
    * @param require the implicit [[NodeRequire require function]]
    * @return the transducer-js instance
    */
  def apply()(implicit require: NodeRequire) = require[TransducersJs]("transducers-js")
